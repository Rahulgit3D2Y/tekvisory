...
$updateusercurrentsession= "UPDATE `user` SET `current_session`='$usercurrentsessionyearrecord' WHERE `id`='$log'";
 ...
 // echo "<script language='javascript'>alert('$inputsessionyear')</script>";
...
<!---------------------------------------------- end User modal ------------------------------------------> 
       <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        ...
        <script src="../admin/js/datatables-simple-demo-2.js"></script>
        <script src="../admin/js/datatables-simple-demo-3.js"></script>
          <script src="../admin/js/datatable.exportable.min.js"></script>
            <script src="../admin/js/datatable.exportable.js"></script>
