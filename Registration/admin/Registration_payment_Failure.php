                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimpl">
                                    ...
                                    <tbody>
                                       ...
                                       $count = 0;
                                        $sql=mysqli_query($con,"SELECT * FROM `registration` WHERE `fee_status`='Rejected' AND `student_status`!='InActive' AND `session`='$activesession_record' ");
         ...
         $specilizationname=$resultspecilizationquery['specilization_name'];
                ...
                //$useramount=$usercountrow12['first_name']." ".$usercountrow12['middle_name']." ".$usercountrow12['last_name'];
                                        ...
                                        <tr>        
                                            ...
                                            <td><?php if(date("d-m-Y", strtotime($result['cpaid_date']))=="01-01-1970"){ echo ""; }else{ echo  date("d-m-Y", strtotime($result['cpaid_date'])); } ?></td>
