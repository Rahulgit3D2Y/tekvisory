 ...
 if (mysqli_num_rows($rs1)>0)
{
    if ($row=mysqli_fetch_row($rs1)) 
    {
        ...
        mysqli_query($con,"INSERT INTO `logindetail` (`logintype`, `loginid`, `password`, `loginattempt`, `ipaddress`, `session_key`,`system_name`, `login_datetime`) values ('$utype','$loginid','$pass1','Failed','$IP','".session_id()."','$systemconfigration','$datetime')") or die(mysqli_error());
    }
}
...
$resultrs2count=$resultrs23['wrong_pass_count'];
 ...
 echo ("<script language='javascript'>alert('$resultrs2count attempt Invalid Username or Password $totalcountwrongatt attempt left');window.location='index.php'</script>"); 
  ...
  {
     mysqli_query($con,"INSERT INTO `logindetail` (`logintype`, `loginid`, `password`, `loginattempt`, `ipaddress`, `session_key`,`system_name`, `login_datetime`) values ('$utype','$loginid','$pass1','Success','$IP','".session_id()."','$systemconfigration','$datetime')") or die(mysqli_error());
