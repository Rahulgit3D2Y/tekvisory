                                    ...
                                    <thead>
                                        <tr>
                                           <th>S.No</th>
                                            ...
                                            <th>Any prior experience in volunteering</th>
                                            <th>How can you help us?</th>
...
$collegeid=$result['student_college'];
 ...
 $campusname=mysqli_query($con,"SELECT * FROM `campus` WHERE `campus_id`='$collegeid'");
                ...
                //$useramount=$usercountrow12['first_name']." ".$usercountrow12['middle_name']." ".$usercountrow12['last_name'];
                                        ...
                                        <tr>        
                                            ...
                                            <td><?php echo  date("d-m-Y", strtotime($reresult['createdtime']));  ?></td>
                                            ...
                                            <td><?php echo $result['student_section']; ?></td>
                                            <td><?php echo $result['classroll']; ?></td>
                                             <td><?php echo $result['student_number']; ?></td>
                                            <td><?php echo $result['student_telegramnumber']; ?></td>
                                            <td><?php echo $result['student_email']; ?></td>
                                           
                                            <td><?php echo $result['hobbies']; ?></td>
                                            <td><?php echo $result['volexperience']; ?></td>
                                            <td><?php echo $result['helpus']; ?></td>
