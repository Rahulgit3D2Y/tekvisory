...
if (mysqli_num_rows($rs)>0)
{
    ...
    echo "<script language='javascript'>alert('Data allready in Exist');window.location='submenu.php'</script>";
...
echo "<script language='javascript'>alert('$submenuname SubMenu Added succesfully');window.location='submenu.php'</script>";
