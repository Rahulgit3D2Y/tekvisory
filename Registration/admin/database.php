...
//mysqli_query($con,$query);
   ...
   echo "<script language='javascript'>alert('$myfile File Deleted');window.location='database.php'</script>";
...
mysqli_query($con,$query);*/
    ...
    echo "<script language='javascript'>alert('$myfile Unable To Restore');window.location='database.php'</script>";
