...
$currentyearfeequery=mysqli_query($con,"SELECT * FROM `course_fee` WHERE `session` ='$activesession_record'");
$rescurrentyearfeequery=mysqli_fetch_assoc($currentyearfeequery);
$currentyearfee=$rescurrentyearfeequery['course_fee'];
