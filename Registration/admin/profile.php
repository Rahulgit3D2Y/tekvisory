...
if(isset($photo_upload))
{
    ...
    $profilephotouploadname=$res['user_id']."_".date('dmY')."".time(); 
    $extension  = pathinfo( $_FILES["PopinputuserPhoto"]["name"], PATHINFO_EXTENSION );
...
$studentPhotoupdatequery="UPDATE `user` SET `photo` = '$basename',`updateby`='$log',`updatetime`='$date' WHERE `id` = '$log' AND `status`=\"Active\"";
