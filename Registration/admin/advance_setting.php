...
$Currenturlpage=basename($_SERVER['REQUEST_URI']); 
$pageurl= parse_url($Currenturlpage, PHP_URL_PATH);
?>
  <meta charset="utf-8" />
<!---------------------  addnotes  Modal ---------------------------->
...
echo "<script language='javascript'>alert('Add succesfully');window.location='advance_setting.php'</script>";
                                            ...
                                            <td><?php echo $result['popupname']; ?></td>
                                              ...
                                              <td>
                                                <?php if($result['popupstatus']=="Active") {?>
                                                    <a href="advance_setting.php?popupid=<?php echo $result['popupid'];?>&action=Disable" onclick="return confirm('Do you really want to Disable <?php echo $modulename ?> Module?');">Disable <?php echo $modulename ?> Module</a>
                                                <?php } else { ?>
                                                    <a href="advance_setting.php?popupid=<?php echo $result['popupid'];?>&action=Enable" onclick="return confirm('Do you really want to  Enable <?php echo $modulename ?> Module?');">Enable <?php echo $modulename ?> Module</a>
