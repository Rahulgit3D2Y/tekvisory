...
$id=$noticequeryresult['id'];
                                        ...
                                        <tr>        
                                            ...
                                            <td><?php if($noticequeryresult['status']=="Active") { ?>
                                                ...
                                                <?php } else {?>
                                                    <a href="?activesession=<?php echo $id;?>"  onclick="return confirm('Do you really want to Active <?php echo $noticequeryresult['session_year']; ?> Session?');" ><i class="fas fa-plus-circle"></i></a>
                                                    <?php } ?></td>
...
include("include/footer.php");
    ?>
     ...
     <a href="<?php echo $modulesettingdisable;?>" onclick="return confirm('Do you really want to Disable <?php echo $modulename; ?> Module?');">
                                                        <i class="fas fa-toggle-on fa-2x" aria-hidden="true" title="Disable <?php echo $modulename; ?> Module"></i>
                                                    </a>